                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-3">
                            ...
                            <label class="block text-xs font-black text-slate-900 uppercase tracking-[0.15em]">Naskah
                                Pernyataan Maklumat (Teks)</label>
                        </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img id="preview-gambar"
                                src="{{ $item->gambar_path ? Storage::url($item->gambar_path) : 'https://via.placeholder.com/400x250?text=Banner+Maklumat' }}"
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-3">
                            <div
                                ...
                                03</div>
                            <label class="block text-xs font-black text-slate-900 uppercase tracking-[0.15em]">Upload
                                Dokumen Lampiran Maklumat Resmi (PDF)</label>
                        </div>
