...
@section('title', 'Kelola LHKPN & LHKASN')
...
@section('content')
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center space-x-3.5">
                    ...
                    <div>
                        <h4 class="font-black text-slate-900 uppercase tracking-tight text-sm">Manajemen LHKPN & LHKASN</h4>
                        <p class="text-[11px] text-slate-500 font-medium mt-0.5">Kelola deskripsi banner, foto infografis, dan upload dua berkas PDF terpisah untuk LHKPN dan LHKASN.</p>
                    </div>
                </div>
                <span
                        ...
                        <div class="lg:col-span-11 w-full space-y-3">
                            ...
                            @if (isset($item->primary_document_path) && $item->primary_document_path)
                                <div
                                    ...
                                    <a href="{{ Storage::url($item->primary_document_path) }}" target="_blank">Lihat Berkas Dokumen LHKPN
                                        Aktif</a>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="lg:col-span-11 w-full space-y-3">
                            ...
                            @if (isset($item->secondary_document_path) && $item->secondary_document_path)
                                <div
                                    class="bg-white border border-emerald-200 p-3 rounded-xl flex items-center space-x-2.5 shadow-3xs text-emerald-700 font-bold text-xs underline decoration-emerald-300 underline-offset-4">
                                    <span class="flex h-2 w-2 rounded-full bg-emerald-500 animate-pulse"></span>
                                    <a href="{{ Storage::url($item->secondary_document_path) }}" target="_blank">Lihat Berkas Dokumen LHKASN
                                        Aktif</a>
                                </div>
                            @endif
                        </div>
    ...
    <script>
        ...
        function confirmDeleteSection(type) {
            ...
            let check1 = confirm("Apakah Anda yakin ingin menghapus komponen " + namaKomponen + " LHKPN?");
            if (check1) {
                let check2 = confirm(
