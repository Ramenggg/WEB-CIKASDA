        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center space-x-3.5">
                    ...
                    <div>
                        <h4 class="font-black text-slate-900 uppercase tracking-tight text-sm">Manajemen Profil LHKPN</h4>
                        <p class="text-[11px] text-slate-500 font-medium mt-0.5">Kelola teks pengumuman kepatuhan,
                            infografis statistik pelaporan, dan file rangkuman LHKPN resmi.</p>
                    </div>
                </div>
                <span
            ...
            <form action="{{ route('admin.profil.update', 'lhkpn') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-3">
                            <div
                                ...
                                01</div>
                            <label class="block text-xs font-black text-slate-900 uppercase tracking-[0.15em]">Naskah
                                Pengantar / Daftar Kepatuhan LHKPN (Teks)</label>
                        </div>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-3">
                            <div
                                ...
                                02</div>
                            <label class="block text-xs font-black text-slate-900 uppercase tracking-[0.15em]">Foto
                                Tangkapan Layar / Infografis Kepatuhan LHKPN</label>
                        </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img id="preview-gambar"
                                src="{{ $item->gambar_path ? Storage::url($item->gambar_path) : 'https://via.placeholder.com/400x250?text=Infografis+LHKPN' }}"
                        ...
                        <div class="lg:col-span-11 w-full space-y-3">
                            ...
                            @if (isset($item->pdf_path) && $item->pdf_path)
                                <div
                                    ...
                                    <a href="{{ Storage::url($item->pdf_path) }}" target="_blank">Lihat Berkas Dokumen LHKPN
                                        Aktif</a>
                                </div>
                            @endif
                        </div>
            ...
            {{-- Form Hapus Bayangan --}}
            <form id="form-hapus-komponen" action="{{ route('admin.profil.update', 'lhkpn') }}" method="POST"
                class="hidden">
                @csrf
