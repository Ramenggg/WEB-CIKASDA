        ...
        <div class="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end min-h-[140px]">
            <div class="flex items-center space-x-2 text-[10px] sm:text-xs font-black tracking-widest uppercase">
                <span class="text-slate-400">PROFIL</span> <span class="text-slate-500 font-medium">›</span> <span
                    class="text-blue-400">LHKPN</span>
            </div>
            <h1
            ...
            <p class="text-slate-300 text-xs sm:text-sm md:text-base font-medium max-w-4xl leading-relaxed opacity-90">
                Transparansi Laporan Harta Kekayaan Penyelenggara Negara (LHKPN) sebagai wujud komitmen integritas dan
                perwujudan tata kelola pemerintahan yang bersih.</p>
        </div>
    </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-8 sm:p-12 lg:p-16 pt-6 space-y-12">
                    ...
                    {{-- DIKUNCI KHUSUS RAW HTML RENDER BIAR EMEDDED TAG LANGSUNG JALAN --}}
                        ...
                        <div
                            ...
                            <div class="flex items-center space-x-4">
                                <div
                                    ...
                                    PDF</div>
                                <h5 class="text-base font-black text-slate-900">Berkas Unduhan Ikhtisar / Tanda Terima LHKPN
                                    Resmi</h5>
                            </div>
                    ...
                    @if (
                        (!isset($item->konten) || empty(trim($item->konten)) || $item->konten === '<p><br></p>') &&
                            !$item->gambar_path &&
                            !$item->pdf_path)
                        <p class="text-center text-slate-400 font-bold py-12">Informasi kepatuhan LHKPN belum di-update oleh
                            admin.</p>
                    @endif
                </div>
            </div>
