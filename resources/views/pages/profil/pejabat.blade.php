        ...
        <div class="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end min-h-[140px]">
            <div class="flex items-center space-x-2 text-[10px] sm:text-xs font-black tracking-widest uppercase">
                <span class="text-slate-400">PROFIL</span> <span class="text-slate-500 font-medium">›</span> <span
                    class="text-blue-400">PEJABAT</span>
            </div>
            <h1
            ...
            <p class="text-slate-300 text-xs sm:text-sm md:text-base font-medium max-w-4xl leading-relaxed opacity-90">
                Mengenal jajaran pimpinan dan pejabat struktural di lingkungan Dinas Cipta Karya dan Sumber Daya Air
            ...
            <div
                ...
                <div class="p-8 sm:p-12 lg:p-16 pt-6 space-y-12">
                    @if (isset($item->konten) && !empty(trim($item->konten)) && $item->konten !== '<p><br></p>')
                        <div
                            class="prose prose-slate max-w-none text-slate-700 leading-relaxed font-medium prose-p:text-lg">
                            {!! $item->konten !!}</div>
                    @endif
                        ...
                        <div
                            ...
                            <div class="flex items-center space-x-4">
                                <div
                                    ...
                                    PDF</div>
                                <h5 class="text-base font-black text-slate-900">SK Penetapan Pejabat Struktural Dinas</h5>
                            </div>
                    ...
                    @if (!isset($item->konten) && !$item->gambar_path && !$item->pdf_path)
                        <p class="text-center text-slate-400 font-bold py-12">Informasi pejabat belum tersedia.</p>
                    @endif
                </div>
            </div>
        </div>
