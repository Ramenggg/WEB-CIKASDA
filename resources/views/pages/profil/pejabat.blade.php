...
@section('content')
    ...
    @php
        ...
        $fotoKadis = $item->primary_image_path ? Storage::url($item->primary_image_path) : asset('images/pejabat/kadis.png');
        $fotoSekretaris = $item->secondary_image_path ? Storage::url($item->secondary_image_path) : asset('images/pejabat/sekretaris.png');
    @endphp

    <x-profil-hero title="Profil Pejabat" :item="$item" :showContentInHero="false" description="Mengenal lebih dekat para pemimpin dan pejabat struktural yang mendedikasikan diri untuk pembangunan infrastruktur di lingkungan Dinas CIKASDA." />
