        ...
        <div class="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end min-h-[140px]">
            <div class="flex items-center space-x-2 text-[10px] sm:text-xs font-black tracking-widest uppercase">
                <span class="text-slate-400">PROFIL</span> <span class="text-slate-500 font-medium">›</span> <span
                    class="text-blue-400">MAKLUMAT PELAYANAN</span>
            </div>
            ...
            <p class="text-slate-300 text-xs sm:text-sm md:text-base font-medium max-w-4xl leading-relaxed opacity-90">
                Pernyataan kesanggupan dan janji resmi jajaran aparatur Dinas Cipta Karya dan Sumber Daya Air untuk
                menyelenggarakan pelayanan publik sesuai standar yang ditetapkan.</p>
        </div>
    </div>
            ...
            <div
                ...
                <div class="px-6 py-4 bg-white border-b border-slate-100 flex items-center justify-between">
                    <div class="flex items-center space-x-2 shrink-0">
                        ...
                        <span
                            class="text-[11px] text-slate-400 font-bold uppercase tracking-wider pl-4 border-l border-slate-100 ml-2">MAKLUMAT
                            RESMI</span>
                    </div>
                    <div
                ...
                <div class="p-8 sm:p-12 lg:p-16 pt-6 space-y-12">
                    ...
                    @if ($item->gambar_path && \Storage::disk('public')->exists($item->gambar_path))
                        <div class="w-full">
                            <div
                                ...
                                <img src="{{ asset('storage/' . $item->gambar_path) }}" alt="Piagam Maklumat Pelayanan"
                        ...
                        <div class="w-full">
                            <div
                                ...
                                <div
                                    ...
                                    <div>
                                        <h5 class="text-base font-black text-slate-900 tracking-tight">Surat Keputusan
                                            Standar Pelayanan Publik Instansi</h5>
                                        <p class="text-xs text-slate-500 font-semibold mt-0.5">Unduh dokumen dasar hukum
                                            keputusan maklumat pelayanan publik (PDF).</p>
                                    </div>
                                </div>
                    ...
                    @if (
                        ...
                        <div class="w-full text-center py-12">
                            <p class="text-slate-400 font-bold">Informasi Maklumat Pelayanan belum tersedia.</p>
                        </div>
                    @endif
                </div>
            </div>
