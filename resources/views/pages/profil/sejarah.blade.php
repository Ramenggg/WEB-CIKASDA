        ...
        <div class="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end min-h-[140px]">
            <div class="flex items-center space-x-2 text-[10px] sm:text-xs font-black tracking-widest uppercase">
                <span class="text-slate-400">PROFIL</span> <span class="text-slate-500 font-medium">›</span> <span
                    class="text-blue-400">SEJARAH SINGKAT</span>
            </div>
            <h1 class="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight mt-3 mb-4 drop-shadow-md">
                Sejarah Singkat</h1>
            <p class="text-slate-300 text-xs sm:text-sm md:text-base font-medium max-w-4xl leading-relaxed opacity-90">Rekam
                jejak, transformasi instansi, dan tonggak perkembangan historis Dinas Cipta Karya dan Sumber Daya Air dari
                masa ke masa.</p>
        </div>
    </div>
            ...
            <div
                ...
                <div class="px-6 py-4 bg-white border-b border-slate-100 flex items-center justify-between">
                    <div class="flex items-center space-x-2 shrink-0">
                        ...
                        <span
                            class="text-[11px] text-slate-400 font-bold uppercase tracking-wider pl-4 border-l border-slate-100 ml-2">HISTORI
                            INSTANSI</span>
                    </div>
                    <div
                ...
                <div class="p-8 sm:p-12 lg:p-16 pt-6 space-y-12">
                    ...
                    @if ($item->gambar_path && \Storage::disk('public')->exists($item->gambar_path))
                        <div class="w-full">
                            <div
                                ...
                                <img src="{{ asset('storage/' . $item->gambar_path) }}" alt="Dokumentasi Sejarah Dinas"
                                ...
                                <div
                                    ...
                                    <span
                                        class="bg-white/95 backdrop-blur-xs text-blue-900 px-6 py-3 rounded-xl font-black shadow-xl opacity-0 group-hover:opacity-100 translate-y-3 group-hover:translate-y-0 transition-all duration-500 text-xs uppercase tracking-[0.2em] border border-blue-100">Lihat
                                        Foto Bersejarah</span>
                                </div>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="w-full">
                            <div
                                ...
                                <div
                                    ...
                                    <div>
                                        <h5 class="text-base font-black text-slate-900 tracking-tight">Arsip Dokumen Sejarah
                                            Pembentukan Instansi</h5>
                                        <p class="text-xs text-slate-500 font-semibold mt-0.5">Unduh berkas laporan sejarah
                                            komplit dalam format PDF resmi.</p>
                                    </div>
                                </div>
                    ...
                    @if (
                        ...
                        <div class="w-full text-center py-12">
                            <p class="text-slate-400 font-bold">Informasi Sejarah belum tersedia.</p>
                        </div>
                    @endif
                </div>
            </div>
